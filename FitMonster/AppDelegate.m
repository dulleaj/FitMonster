...
didSignInForUser:(GIDGoogleUser *)user
    ...
    if (error == nil) {
        ...
        */
        ...
        StepsViewController* stepsViewController = [storyboard instantiateViewControllerWithIdentifier:@"StepsViewController"];
        self.window.rootViewController = stepsViewController;
